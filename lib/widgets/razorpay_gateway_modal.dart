...
class CustomerRazorpayGatewayModalSheet extends StatefulWidget {
  final String orderId;
  final String keyId;
  final double amount;
  final String title;

  const CustomerRazorpayGatewayModalSheet({
    super.key,
    required this.orderId,
    required this.keyId,
    required this.amount,
    this.title = 'BharatClap Customer Services',
  });

  @override
  State<CustomerRazorpayGatewayModalSheet> createState() => _CustomerRazorpayGatewayModalSheetState();
}

class _CustomerRazorpayGatewayModalSheetState extends State<CustomerRazorpayGatewayModalSheet> {
  ...
  Future<void> _executePayment() async {
    ...
    if (!mounted) return;
    setState(() {
      _processingStep = 'Authenticating payment details...';
    });
              ...
              child: Column(
                children: [
                  AnimatedContainer(
                    ...
                    padding: const EdgeInsets.all(20),
                    decoration: BoxDecoration(
                      color: _isSuccess ? Colors.green.shade50 : const Color(0xFF0C2340).withValues(alpha: 0.08),
                      ...
                      children: _upiApps.map((app) {
                        ...
                        return GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: isAppSelected ? const Color(0xFF0C2340).withValues(alpha: 0.05) : Colors.white,
                            ...
                            child: Row(
                              children: [
                                ...
                                Icon(
                                  isAppSelected ? Icons.radio_button_checked : Icons.radio_button_off,
                                  color: isAppSelected ? const Color(0xFF0C2340) : Colors.grey,
                                  size: 20,
                                ),
                              ],
                            ),
