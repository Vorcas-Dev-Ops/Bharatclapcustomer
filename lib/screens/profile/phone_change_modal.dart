...
class PhoneChangeModal extends StatefulWidget {
  ...
  static Future<void> show(
    ...
    return showModalBottomSheet(
      ...
      builder: (context) => PhoneChangeModal(
  ...
  @override
  State<PhoneChangeModal> createState() => _PhoneChangeModalState();
}

class _PhoneChangeModalState extends State<PhoneChangeModal> {
  ...
  Future<void> _handleInitiate() async {
    ...
    final res = await ApiService.initiatePhoneChange(formattedPhone);
  ...
  Future<void> _handleVerify() async {
    ...
    final res = await ApiService.verifyPhoneChange(formattedPhone, otpCode);
    ...
    if (mounted) {
      if (res['success'] == true) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(res['message'] ?? 'Mobile number updated successfully!'),
            backgroundColor: Colors.green,
          ),
        );
      } else {
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Text(
                _step == 1 ? 'Change Phone Number' : 'Verify New Number',
          ...
          if (_step == 1) ...[
            const Text(
              'Enter your new 10-digit mobile number. An OTP will be sent to verify your ownership.',
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                prefixIcon: const Padding(
                  ...
                  child: Text('+91 ', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15, color: Color(0xFF1B1464))),
                ),
                    ...
                    decoration: InputDecoration(
                      ...
                      enabledBorder: OutlineInputBorder(
                        ...
                        borderSide: BorderSide(
                          color: _otpControllers[index].text.isNotEmpty ? const Color(0xFF1B1464) : Colors.grey.shade300,
                        ),
                      ),
                    ),
                  ),
              ...
              children: [
                ...
                TextButton(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                      color: _canResend ? const Color(0xFF1B1464) : Colors.grey,
                      fontWeight: FontWeight.bold,
                    ),
                  ),
                ),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: _isLoading
                    ? const SizedBox(width: 20, height: 20, child: CircularProgressIndicator(color: Colors.white, strokeWidth: 2))
                    : const Text('Confirm & Update Number', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 15)),
              ),
            ),
          ],
        ],
